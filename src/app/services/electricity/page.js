        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-stone-800">UPM Electricity Services</h1>
          ...
          <div className="w-full lg:w-1/4">
            <div className="bg-white rounded-xl shadow-md border border-stone-200 p-6 mb-6">
              ...
              <div className="space-y-3">
                <a href="#" className="block text-stone-600 hover:text-amber-600 transition-colors duration-200 p-2 rounded-lg hover:bg-amber-50">
            ...
            <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg">
              <p className="font-semibold text-amber-800 mb-2">📢 Notice</p>
              <p className="text-amber-700 text-sm">
                Scheduled maintenance: System will be down from 2AM to 4AM on Sunday, 20-08-2025
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-3/4">
            <div className="bg-white rounded-xl shadow-md border border-stone-200 p-8 mb-6">
              <h2 className="text-3xl font-bold text-stone-800 mb-6 text-center">
                Check & Pay Your Electricity Bill
              </h2>
              ...
              {!billAmount ? (
                <form onSubmit={handleCheckBill} className="bg-stone-50 border border-stone-200 p-6 rounded-lg shadow-sm">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-amber-600 text-white font-semibold py-3 px-4 rounded-lg hover:bg-amber-700 transition-colors duration-200 shadow-md disabled:opacity-50"
                  >
      ...
      <footer className="bg-stone-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h4 className="text-xl font-bold mb-4 text-amber-400">UPM Electricity</h4>
              <p className="text-stone-300 text-sm">
                The United Pingdom of MINET<br />
                Powering progress since 1999
              </p>
            </div>
            <div>
              <h4 className="text-xl font-bold mb-4 text-amber-400">Quick Links</h4>
              <ul className="space-y-2 text-stone-300 text-sm">
                <li><a href="#" className="hover:text-amber-400 transition-colors">Power Outages</a></li>
                <li><a href="#" className="hover:text-amber-400 transition-colors">New Connection</a></li>
            ...
            <div>
              ...
              <div className="text-stone-300 text-sm space-y-2">
                <p>⚡ Electricity Complex, Susland</p>
                <p>📞 1-800-UPM-POWER</p>
                <p>📧 power@upm.gov.minet</p>
              </div>
            </div>
          </div>
